...
export const LightTunnel = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('LightTunnel: WebGL initialization failed.', error);
      return;
    }
