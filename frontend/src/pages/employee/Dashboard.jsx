...
export default function Dashboard({ user }) {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      {/* 1. WELCOME SECTION WRAPPED IN BORDERGLOW */}
      <BorderGlow
        borderRadius={24}
          ...
          <div className="p-6 space-y-4 flex flex-col justify-between h-full">
            <div className="space-y-4">
              <div className="flex items-center justify-between pb-2 border-b border-slate-800/80">
                ...
                <span className="text-xs font-semibold text-indigo-300 bg-indigo-950/80 border border-indigo-500/30 px-2.5 py-1 rounded-full">
              ...
              {loading ? (
                <div className="space-y-3 animate-pulse">
                  {[1, 2, 3].map((n) => (
                    <div key={n} className="p-3.5 rounded-xl border border-slate-800 space-y-2">
                ...
                <div className="py-10 text-center space-y-2">
                  ...
                  <h3 className="text-sm font-bold text-slate-200">No recent activity</h3>
