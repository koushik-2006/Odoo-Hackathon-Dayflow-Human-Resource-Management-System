...
export default function Dashboard({ user }) {
  ...
  const employeeName = user?.name || user?.fullName || 'John';
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      // We don't crash, but display a soft error notice if explicitly desired
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      {/* 2. RESPONSIVE STATISTICS GRID (Desktop: 4 cols, Tablet: 2 cols, Mobile: 1 col) */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white rounded-2xl p-6 border border-slate-100 shadow-sm space-y-4 flex flex-col justify-between">
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              /* Map through array of activities */
        ...
        <div className="lg:col-span-2 bg-white rounded-2xl p-6 border border-slate-100 shadow-sm space-y-4">
          ...
          {loading ? (
            ...
            /* Responsive Recharts Mini-Chart Container */
