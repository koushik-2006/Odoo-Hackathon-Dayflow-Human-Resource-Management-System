...
import { checkIn, checkOut, getMyAttendance, getMonthlyAttendance } from '../../services/attendanceService';

// Fallback Mock Data for Attendance Logs & Calendar
const MOCK_ATTENDANCE_LOGS = [
  { id: 1, date: '2026-08-22', dateFormatted: 'Aug 22, 2026', checkIn: '09:02 AM', checkOut: '05:48 PM', hours: '8h 46m', status: 'Present' },
  { id: 2, date: '2026-08-21', dateFormatted: 'Aug 21, 2026', checkIn: '08:55 AM', checkOut: '05:35 PM', hours: '8h 40m', status: 'Present' },
  { id: 3, date: '2026-08-20', dateFormatted: 'Aug 20, 2026', checkIn: '-', checkOut: '-', hours: '-', status: 'Leave' },
  { id: 4, date: '2026-08-19', dateFormatted: 'Aug 19, 2026', checkIn: '09:15 AM', checkOut: '01:45 PM', hours: '4h 30m', status: 'Half Day' },
  { id: 5, date: '2026-08-18', dateFormatted: 'Aug 18, 2026', checkIn: '09:00 AM', checkOut: '06:00 PM', hours: '9h 00m', status: 'Present' },
  { id: 6, date: '2026-08-17', dateFormatted: 'Aug 17, 2026', checkIn: '08:45 AM', checkOut: '05:30 PM', hours: '8h 45m', status: 'Present' },
  { id: 7, date: '2026-08-14', dateFormatted: 'Aug 14, 2026', checkIn: '-', checkOut: '-', hours: '-', status: 'Absent' },
];
...
export default function Attendance() {
  // State for Today's Attendance status
